    ...
    >
      <template>
        ...
        >
          ...
          <el-table-column prop="Address" zh-label="Address" label="Address">
            <template slot-scope="scope">
              <span>{{ scope.row.Address || "-" }}</span>
            </template>
          </el-table-column>
          <el-table-column prop="Quantity" zh-label="Quantity" label="Quantity">
            <template slot-scope="scope">
              <span>{{ scope.row.Quantity || "-" }}</span>
            </template>
          </el-table-column>
          <el-table-column prop="Percentage" zh-label="Percentage" label="Percentage">
            <template slot-scope="scope">
              <span>
  ...
  data() {
    return {
      ...
      tableData: [
        {
          Rank: "1",
          Address: "kskajdlkajldsjaldjdkajldjl",
          Quantity: "738217938713",
          Percentage: 18.987,
        },
        {
          Rank: "2",
